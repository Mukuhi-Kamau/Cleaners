...
var_dump(count($wambua_corrupted_employees_array));

$columns=8;
$line_array=array(8,16,32,40,48,56,64,72,80,88,96,104,112.120,128,136,144,152,160,168,176,184,192,200,208,216,224,232,240,248,256);
?>
<table border="1" cellpadding=1 cellspacing=0>
  <thead>
    ...
    for($i=0;$i<$columns;$i++){
      ...
      <th>
        <?php
        echo ucwords(strtolower( $wambua_corrupted_employees_array[$i]));
      ?>
       </th>
       <?php
    ...
    <tbody>
      <?php
      for($b=0;$b<$line_array[$b];$b++){?>
        <tr>
        <?php

      for($i=8;$i<$line_array[$b];$i++){?>
        <th>
        <td>
          <?php
          echo ucwords(strtolower($wambua_corrupted_employees_array[$i]));
